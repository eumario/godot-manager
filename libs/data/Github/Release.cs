...
namespace Github {
	...
	public class Release : Object {
		...
		[JsonProperty] public string HtmlUrl;
		[JsonProperty] public string AssetsUrl;
		[JsonProperty] public string UploadUrl;
		[JsonProperty] public string TarballUrl;
		[JsonProperty] public string ZipballUrl;
		[JsonProperty] public int Id;
		[JsonProperty] public string NodeId;
		[JsonProperty] public string TagName;
		[JsonProperty] public string TargetCommitish;
		[JsonProperty] public string Name;
		[JsonProperty] public string Body;
		[JsonProperty] public bool Draft;
		[JsonProperty] public bool PreRelease;
		[JsonProperty] public DateTime CreatedAt;
		[JsonProperty] public DateTime PublishedAt;
